...
function ProjectsPage() {
  return (
    <section className='h-[100vh] w-full flex Project bg-white'>
      ...
      <main className='glass-effect-3 bg-white bg-opacity-50 backdrop-blur-xl h-[100vh] flex-grow flex flex-col'>
        <div className='Home-box pt-3 w-full flex-grow overflow-auto'> 
          <section className='bg-blue-500 w-full h-[15rem]'>
            <div>Project</div>
          </section>
              ...
              {[...Array(8)].map((_, index) => (
                <li key={index} className='Demo-Cards w-[19.3rem] h-auto'>
                  <div className='bg-white h-auto Project-Card p-2 shadow-custom rounded-xl flex flex-col gap-2 border-2'>
                    <div className='relative flex items-start justify-between mb-2 h-[10rem] Project-Image-container rounded-2xl overflow-hidden'>
                      <img 
